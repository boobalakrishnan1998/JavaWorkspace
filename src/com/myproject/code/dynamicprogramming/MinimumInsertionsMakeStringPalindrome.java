...
public class MinimumInsertionsMakeStringPalindrome {
    public static void main(String[] args) {
        ...
        String str2 = String.valueOf(new StringBuilder(str1).reverse());
        char[] longestPalSubSequence = funcTab(str1.toCharArray(), str2.toCharArray());
        int ans = str1.length()-longestPalSubSequence.length;
