...
public class BestTimeToBuySellStockIV {
    public static void main(String[] args) {
        ...
        int noOfTrades = 2;
        int ans = findMax(price, noOfTrades);
        ...
        for (int ind = n - 1; ind >= 0; ind--) {
            ...
            for (int transNo = 2 * noOfTrades - 1; transNo >= 0; transNo--) {
                ...
                if (transNo % 2 == 0) {
                    ...
                    int sell = price[ind] + after[transNo + 1];
        ...
        for (int ind = n - 1; ind >= 0; ind--) {
            for (int transNo = 2 * noOfTrades - 1; transNo >= 0; transNo--) {
                ...
                if (transNo % 2 == 0) {
                    ...
                    int sell = price[ind] + dp[ind + 1][transNo + 1];
    ...
    public static int stockBuySellDp(int ind, int transNo, int[] price, int noOfTrades, int[][] dp) {
        ...
        if (transNo % 2 == 0) {
            ...
            int sell = price[ind] + stockBuySellDp(ind + 1, transNo + 1, price, noOfTrades, dp);
    ...
    public static int stockBuySell(int ind, int transNo, int[] price, int noOfTrades) {
        ...
        if (transNo % 2 == 0) {
            ...
            int sell = price[ind] + stockBuySell(ind + 1, transNo + 1, price, noOfTrades );
