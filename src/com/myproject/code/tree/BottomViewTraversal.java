...
public class BottomViewTraversal {//Root , Left , Right
    ...
    public static void main(String[] args) {
        ...
        // Getting Bottom view traversal
        List<Integer> result = bottomViewTraversal(root);
        // Displaying the Bottom view traversal result
    ...
    public static List<Integer> bottomViewTraversal(Node root) {
