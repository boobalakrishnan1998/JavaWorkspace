...
public class StringPermutations {
    ...
    private static void permutation(String perm, String word) {
        if (word.isEmpty()) {
            System.out.println("Final permuatations "+ perm + word);
        } else {
            for (int i = 0; i < word.length(); i++) {
                String perm_wordChar_i =perm + word.charAt(i);
                String wordSubStr0_i__wordSubStri_1__word_len = word.substring(0, i)+word.substring(i + 1);
                permutation(perm_wordChar_i, wordSubStr0_i__wordSubStri_1__word_len);
            }
        }
    }
}
/*
                ...
                System.out.println("i "+i);
                        System.out.println("permutation("+perm_wordChar_i+","+wordSubStr0_i__wordSubStri_1__word_len+")");*/
