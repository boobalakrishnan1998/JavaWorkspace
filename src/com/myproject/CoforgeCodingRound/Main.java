...
public class Main {
/*
    You are given a file named input.txt that contains three lines.
    Each line represents a string. Write a Java function that reads the strings from the file and
     finds and returns the length of the longest substring without repeating characters in each string.
*/
